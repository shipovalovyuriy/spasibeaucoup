...
/**
 * Description of ListnerButtonColumn
 *
 * @author Каиржан
 */
...
class FrontButtonColumn extends \TbButtonColumn {
    public $template = '{front_view} {view} {update}';
    /**
     * @var string the view button icon (defaults to 'eye-open').
     */
    public $viewButtonIcon = 'fa fa-fw fa-eye';
    
    public $positionButtonIcon = 'fa fa-fw fa-file-text-o';
    /**
