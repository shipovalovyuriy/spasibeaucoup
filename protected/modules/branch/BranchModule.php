<?php
/**
 * BranchModule основной класс модуля branch
 *
 * @author yupe team <team@yupe.ru>
 * @link http://yupe.ru
 * @copyright 2009-2016 amyLabs && Yupe! team
 * @package yupe.modules.branch
 * @since 0.1
 */

class BranchModule  extends yupe\components\WebModule
{
    const VERSION = '0.9.8';
    ...
    {
        return Yii::t('BranchModule.branch', 'Spasibeaucoup');
    }
    ...
    {
        return [
            ['label' => Yii::t('BranchModule.branch', 'Филиалы')],
            [
                'icon' => 'fa fa-fw fa-list-alt',
                'label' => Yii::t('BranchModule.branch', 'Список Филиалов'),
                'url' => ['/branch/branchBackend/index'],
                
            ],
            [
                'icon' => 'fa fa-fw fa-plus-square',
                'label' => Yii::t('BranchModule.branch', 'Добавить Филиал'),
                'url' => ['/branch/branchBackend/create'],
            ],
        ];
    }
    ...
    {
        return Yii::t('BranchModule.branch', self::VERSION);
    }
    ...
    {
        //return Yii::t('BranchModule.branch', 'http://yupe.ru');
    }
    ...
    {
        return Yii::t('BranchModule.branch', 'Филиал');
    }
    ...
    {
        return Yii::t('BranchModule.branch', 'Описание модуля "branch"');
    }
    ...
    {
        return Yii::t('BranchModule.branch', 'sepaker');
    }
    ...
    {
        return Yii::t('BranchModule.branch', 'sepaker079@gmail.com');
    }
    ...
    {
        return '/branch/branchBackend/index';
    }
    ...
    public function getAuthItems()
    {
        return [
            [
                'name' => 'Branch.BranchManager',
                'description' => Yii::t('BranchModule.branch', 'Manage branch'),
                'type' => AuthItem::TYPE_TASK,
                'items' => [
                    [
                        'type' => AuthItem::TYPE_OPERATION,
                        'name' => 'Branch.BranchBackend.Index',
                        'description' => Yii::t('BranchModule.branch', 'Index')
                    ],
                ]
            ]
        ];
