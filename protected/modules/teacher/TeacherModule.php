<?php
/**
 * TeacherModule основной класс модуля teacher
 *
 * @author yupe team <team@yupe.ru>
 * @link http://yupe.ru
 * @copyright 2009-2016 amyLabs && Yupe! team
 * @package yupe.modules.teacher
 * @since 0.1
 */

class TeacherModule  extends yupe\components\WebModule
{
    const VERSION = '0.9.8';
    ...
    {
        return Yii::t('TeacherModule.teacher', 'СпасиBeaucoup');
    }
    ...
    {
        return [
            ['label' => Yii::t('TeacherModule.teacher', 'Учителя')],
            [
                'icon' => 'fa fa-fw fa-list-alt',
                'label' => Yii::t('TeacherModule.teacher', 'Список Учителей'),
                'url' => ['/teacher/teacherBackend/index']
            ],
            [
                'icon' => 'fa fa-fw fa-plus-square',
                'label' => Yii::t('TeacherModule.teacher', 'Добавить Учителя'),
                'url' => ['/teacher/teacherBackend/create'],
            ],
        ];
    }
    ...
    {
        return Yii::t('TeacherModule.teacher', self::VERSION);
    }
    ...
    {
        //return Yii::t('TeacherModule.teacher', 'http://yupe.ru');
    }
    ...
    {
        return Yii::t('TeacherModule.teacher', 'Учителя');
    }
    ...
    {
        return Yii::t('TeacherModule.teacher', 'Описание модуля "teacher"');
    }
    ...
    {
        return Yii::t('TeacherModule.teacher', 'sepaker');
    }
    ...
    {
        return Yii::t('TeacherModule.teacher', 'sepaker079@gmail.com');
    }
    ...
    {
        return '/teacher/teacherBackend/index';
    }
    ...
    public function getAuthItems()
    {
        return [
            [
                'name' => 'Teacher.TeacherManager',
                'description' => Yii::t('TeacherModule.teacher', 'Manage teacher'),
                'type' => AuthItem::TYPE_TASK,
                'items' => [
                    [
                        'type' => AuthItem::TYPE_OPERATION,
                        'name' => 'Teacher.TeacherBackend.Index',
                        'description' => Yii::t('TeacherModule.teacher', 'Index')
                    ],
                ]
            ]
        ];
