...
$this->breadcrumbs = [
    ...
    $model->name => ['/listner/formBackend/view', 'id' => $model->id],
    Yii::t('ListnerModule.listner', 'Редактирование'),
];

$this->pageTitle = Yii::t('ListnerModule.listner', 'Тарифы - редактирование');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('ListnerModule.listner', 'Редактирование') . ' ' . Yii::t('ListnerModule.listner', 'Тарифа'); ?>        <br/>
