<?php
/**
 * ListnerModule основной класс модуля listner
 *
 * @author yupe team <team@yupe.ru>
 * @link http://yupe.ru
 * @copyright 2009-2016 amyLabs && Yupe! team
 * @package yupe.modules.listner
 * @since 0.1
 */

class ListnerModule  extends yupe\components\WebModule
{
    const VERSION = '0.9.8';
    ...
    {
        return Yii::t('ListnerModule.listner', 'СпасиBeaucoup');
    }
    ...
    {
        return [
            ['label' => Yii::t('ListnerModule.listner', 'listner')],
            [
                'icon' => 'fa fa-fw fa-list-alt',
                'label' => Yii::t('ListnerModule.listner', 'Список Слушателей'),
                'url' => ['/listner/listnerBackend/index']
            ],
            [
                'icon' => 'fa fa-fw fa-plus-square',
                'label' => Yii::t('ListnerModule.listner', 'Добавить Слушателя'),
                'url' => ['/listner/listnerBackend/create'],
            ],
        ];
    }
    ...
    {
        return Yii::t('ListnerModule.listner', self::VERSION);
    }
    ...
    {
       // return Yii::t('ListnerModule.listner', 'http://yupe.ru');
    }
    ...
    {
        return Yii::t('ListnerModule.listner', 'listner');
    }
    ...
    {
        return Yii::t('ListnerModule.listner', 'Описание модуля "listner"');
    }
    ...
    {
        return Yii::t('ListnerModule.listner', 'sepaker');
    }
    ...
    {
        return Yii::t('ListnerModule.listner', 'sepaker@gmail.com');
    }
    ...
    {
        return '/listner/listnerBackend/index';
    }
    ...
    public function getAuthItems()
    {
        return [
            [
                'name' => 'Listner.ListnerManager',
                'description' => Yii::t('ListnerModule.listner', 'Manage listner'),
