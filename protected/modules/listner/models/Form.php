 ...
 *
 * The followings are the available columns in table '{{form_form}}':
 * @property integer $id
 ...
 */
class Form extends yupe\models\YModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, description, price, old_price, type_id, number', 'required'),
			array('type_id, number, price, old_price', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			...
			'positions' => array(self::HAS_MANY, 'Position', 'form_id'),
		);
	}
