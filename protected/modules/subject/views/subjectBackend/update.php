...
$this->breadcrumbs = [
    ...
    $model->name => ['/subject/subjectBackend/view', 'id' => $model->id],
    Yii::t('SubjectModule.subject', 'Редактирование'),
];

$this->pageTitle = Yii::t('SubjectModule.subject', 'Предметы - редактирование');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('SubjectModule.subject', 'Редактирование') . ' ' . Yii::t('SubjectModule.subject', 'Предмета'); ?>        <br/>
        <small>&laquo;<?php echo $model->name; ?>&raquo;</small>
    </h1>
</div>

<?php echo $this->renderPartial('_form', ['model' => $model, 'teachers' => $teachers,]); ?>