<?php
/**
 * SubjectModule основной класс модуля subject
 *
 * @author yupe team <team@yupe.ru>
 * @link http://yupe.ru
 * @copyright 2009-2016 amyLabs && Yupe! team
 * @package yupe.modules.subject
 * @since 0.1
 */

class SubjectModule  extends yupe\components\WebModule
{
    const VERSION = '0.9.8';
    ...
    {
        return Yii::t('SubjectModule.subject', 'СпасиBeaucoup');
    }
    ...
    {
        return [
            ['label' => Yii::t('SubjectModule.subject', 'Предметы')],
            [
                'icon' => 'fa fa-fw fa-list-alt',
                'label' => Yii::t('SubjectModule.subject', 'Список Предметов'),
                'url' => ['/subject/subjectBackend/index']
            ],
            [
                'icon' => 'fa fa-fw fa-plus-square',
                'label' => Yii::t('SubjectModule.subject', 'Добавить Предмет'),
                'url' => ['/subject/subjectBackend/create'],
            ],
        ];
    }
    ...
    {
        return Yii::t('SubjectModule.subject', self::VERSION);
    }
    ...
    {
        #return Yii::t('SubjectModule.subject', 'http://yupe.ru');
    }
    ...
    {
        return Yii::t('SubjectModule.subject', 'Предметы');
    }
    ...
    {
        return Yii::t('SubjectModule.subject', 'Описание модуля "subject"');
    }
    ...
    {
        return Yii::t('SubjectModule.subject', 'sepaker');
    }
    ...
    {
        return Yii::t('SubjectModule.subject', 'sepaker079@gmail.com');
    }
    ...
    {
        return '/subject/subjectBackend/index';
    }
    ...
    public function getAuthItems()
    {
        return [
            [
                'name' => 'Subject.SubjectManager',
                'description' => Yii::t('SubjectModule.subject', 'Manage subject'),
                'type' => AuthItem::TYPE_TASK,
                'items' => [
                    [
                        'type' => AuthItem::TYPE_OPERATION,
                        'name' => 'Subject.SubjectBackend.Index',
                        'description' => Yii::t('SubjectModule.subject', 'Index')
                    ],
                ]
            ]
        ];
