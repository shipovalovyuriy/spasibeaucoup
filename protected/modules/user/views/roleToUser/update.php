...
$this->breadcrumbs = [
    ...
    $model->id => ['/user/roleToUser/view', 'id' => $model->id],
    Yii::t('UserModule.user', 'Редактирование'),
];

$this->pageTitle = Yii::t('UserModule.user', 'Должности - редактирование');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('UserModule.user', 'Редактирование') . ' ' . Yii::t('UserModule.user', 'Должности'); ?>        <br/>
