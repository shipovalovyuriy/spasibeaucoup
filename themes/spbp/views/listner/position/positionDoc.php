...
<table dir="LTR" width="999" cellpadding="7" cellspacing="0">
		...
		<col width="484">
			...
			<td width="484" style="border-right: 1px solid #00000a; padding: 0in 0.08in">
				...
				<ol>
					<li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">1. УСЛОВИЯ
					ПОЛУЧЕНИЯ УСЛУГ:</font></font></p>
					<ol>
						<li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">1.1. Получение
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">1.2. согласно
						...
						</li><li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">1.3. <b>НАЧАЛО</b></font></font><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">1.4. <b>КОНЕЦ</b></font></font><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">1.5. Общее
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">1.6. Длительность
						...
						астрономический час.</font></font></font></p>
                                        ...
                                        <li>
                                            <p style="margin-bottom: 0in"><font color="#ff0000"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">Номер
				...
				индивидуального учета посещаемости
                                (подчеркнуть): <?= $model->code?></font></font></font></p>
                                        ...
                                        <li><font color="#ff0000"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt"><font color="#000">1.7. </font>Контакты:
						<?= $model->listner->phone?></font></font></font>
					</li>
                                        </ol>
				</li></ol>
				
				<ol>
					<li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">2. УСЛОВИЯ
					ПОЛУЧЕНИЯ СЕРТИФИКАТА, СВИДЕТЕЛЬСТВУЮЩИЕ
					ОБ УРОВНЕ ЗНАНИЯ ЯЗЫКА</font></font></p>
					<ol>
						<li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">2.1. Получении
						услуг в сфере дополнительного
						...
						</li><li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">2.2. Срок
						...
						</li><li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">2.3. Высокий
						уровень посещаемости. Ежемесячное
						позволительное количество пропусков
						– 2 (два).</font></font></p>
						</li><li><p style="margin-bottom: 0in">  <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">2.4. Сдача
						итогового экзамена. </font></font>
						</p>
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">2.5. Уровень
						знания языка указывается на сертификате
						согласно итоговому экзамену. </font></font>
						</p>
					</li></ol>
					</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">3. УСЛОВИЯ
					ПО ПЕРЕВОДУ ОПЛАЧЕННЫХ ДЕНЕЖНЫХ
					СРЕДСТВ НА РЕЗЕРВ</font></font></p>
					<ol>
						<li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">3.1. Перевод
					...
					</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">4. УСЛОВИЯ
					ВОЗВРАТА ОПЛАЧЕННЫХ ДЕНЕЖНЫХ СРЕДСТВ</font></font></p>
					<ol>
						<li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">4.1. Полный
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">4.2. Полный
						или частичный возврат денежных
					...
					</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">5. ПЕРЕНОС
					И/ИЛИ РЕГУЛЯЦИЯ РАСПИСАНИЯ</font></font></p>
					<ol>
						<li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt"><b>5.1. ПЕРЕНОС
						...
						<?= $admin->last_name . ' ' . $admin->first_name?> : &nbsp; +7 707 7000 434</b></font></font><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">5.2. Перенос
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">5.3. При
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">5.4. Перенос
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">5.5. Перенос
						уроков осуществляется на время в
						...
						</li><li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">5.6. При
					...
					</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">6. ДРУГИЕ
					УСЛОВИЯ</font></font></p>
					<ol>
						<li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">6.1. Приобретение
						...
						п.п.1.2...</font></font></p>
						</li><li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">6.2. При
						...
						</li><li><p style="margin-bottom: 0in"> <font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">6.3. Компания
						...
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">6.4. Настоящее
						Положение действительно при наличии
						абонемента с информацией о сроках
						прохождения курса и Печатью Компании</font></font></p>
						</li><li><p style="margin-bottom: 0in"><font face="Times New Roman, serif"><font size="1" style="font-size: 6pt">6.5. Положение
