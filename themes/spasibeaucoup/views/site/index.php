                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li class="active"><a href="index-2.html"><i class="icon-home4"></i> <span>Dashboard</span></a></li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="index-2.html" id="layout1">Layout 1 <span class="label bg-warning-400">Current</span></a></li>
                                    <li><a href="http://demo.interface.club/limitless/layout_2/LTR/index.html" id="layout2">Layout 2</a></li>
                                    ...
                                    <li class="disabled"><a href="http://demo.interface.club/limitless/layout_5/LTR/index.html" id="layout5">Layout 5 <span class="label">Coming soon</span></a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li><a href="http://demo.interface.club/limitless/layout_1/RTL/index.html"><i class="icon-width"></i> <span>RTL version</span></a></li>
                            <!-- /main -->
